...
//		System.out.println(10 / 3);		// 1번 통로 출력
//		System.out.println(10 / 0);		// 2번 통로 출력
		
		System.out.print("아무 키나 입력하세요 : ");
		int data = System.in.read();		// keyCode를 정수로 입력받는다(원시적인 데이터)
		System.out.println("data : " + data);
		System.out.println((char)44032); 	// 한글코드
		...
		// 한글자씩 입력받으면 문장단위 입력이 매루 까다롭기 때문에 일정크기로 입력받는 형식으로 바꾼다
